...
copy oemlogo.bmp %SystemDrive%\Windows\ottooem.bmp
...
reg add HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Windows\CurrentVersion\OEMInformation /v logo /t REG_SZ /d "%SystemDrive%/Windows/ottooem.bmp" /f
reg add HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Windows\CurrentVersion\OEMInformation /v SupportPhone /t REG_SZ /d "010" /f
